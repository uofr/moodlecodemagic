...
$string['codemagic:undo'] = 'Undo';
$string['codemagic:redo'] = 'Redo';
$string['codemagic:search_replace'] = 'Search and Replace';
$string['codemagic:reintendt'] = 'Format HTML code';
$string['codemagic:nothing_found'] = 'Nothing found.';
$string['codemagic:nothing_to_replace'] = 'Nothing to replace.';
